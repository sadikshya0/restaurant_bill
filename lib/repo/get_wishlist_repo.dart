...
class GetWishlistRepo {
  static Future<void> wishlistRepo({
    required Function(List<Wishlist> wishlist) onSuccess,
    ...
    try {
      ...
      log("HEADERS => $headers");
      var url = Uri.parse(Api.wishlistUrl);
      ...
      if (response.statusCode >= 200 && response.statusCode < 300) {
        ...
        if (rawList != null && rawList is List) {
          final wishlist = wishlistFromJson(rawList);
          onSuccess(wishlist);
        } else {
          onSuccess([]);
        }
